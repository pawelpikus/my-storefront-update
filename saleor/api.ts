...
export type ProductFetchTwelveElementsQueryVariables = Exact<{ [key: string]: never; }>;


export type ProductFetchTwelveElementsQuery = { __typename?: 'Query', products?: { __typename?: 'ProductCountableConnection', edges: Array<{ __typename?: 'ProductCountableEdge', node: { __typename?: 'Product', id: string, name: string, thumbnail?: { __typename?: 'Image', url: string } | null, category?: { __typename?: 'Category', name: string } | null } }> } | null };
...
export const ProductFetchTwelveElementsDocument = gql`
    query ProductFetchTwelveElements {
...
/**
 * __useProductFetchTwelveElementsQuery__
 *
 * To run a query within a React component, call `useProductFetchTwelveElementsQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductFetchTwelveElementsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProductFetchTwelveElementsQuery({
 *   variables: {
 *   },
 * });
 */
export function useProductFetchTwelveElementsQuery(baseOptions?: Apollo.QueryHookOptions<ProductFetchTwelveElementsQuery, ProductFetchTwelveElementsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ProductFetchTwelveElementsQuery, ProductFetchTwelveElementsQueryVariables>(ProductFetchTwelveElementsDocument, options);
      }
export function useProductFetchTwelveElementsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProductFetchTwelveElementsQuery, ProductFetchTwelveElementsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ProductFetchTwelveElementsQuery, ProductFetchTwelveElementsQueryVariables>(ProductFetchTwelveElementsDocument, options);
        }
export type ProductFetchTwelveElementsQueryHookResult = ReturnType<typeof useProductFetchTwelveElementsQuery>;
export type ProductFetchTwelveElementsLazyQueryHookResult = ReturnType<typeof useProductFetchTwelveElementsLazyQuery>;
export type ProductFetchTwelveElementsQueryResult = Apollo.QueryResult<ProductFetchTwelveElementsQuery, ProductFetchTwelveElementsQueryVariables>;
 ...
 * });
 */
export function useProductGetThreeElementsQuery(baseOptions?: Apollo.QueryHookOptions<ProductGetThreeElementsQuery, ProductGetThreeElementsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ProductGetThreeElementsQuery, ProductGetThreeElementsQueryVariables>(ProductGetThreeElementsDocument, options);
      }
export function useProductGetThreeElementsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProductGetThreeElementsQuery, ProductGetThreeElementsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ProductGetThreeElementsQuery, ProductGetThreeElementsQueryVariables>(ProductGetThreeElementsDocument, options);
        }
...
/**
 * __useProductSearchtShirtQuery__
 *
 * To run a query within a React component, call `useProductSearchtShirtQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductSearchtShirtQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useProductSearchtShirtQuery({
 *   variables: {
 *   },
 * });
 */
export function useProductSearchtShirtQuery(baseOptions?: Apollo.QueryHookOptions<ProductSearchtShirtQuery, ProductSearchtShirtQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ProductSearchtShirtQuery, ProductSearchtShirtQueryVariables>(ProductSearchtShirtDocument, options);
      }
export function useProductSearchtShirtLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ProductSearchtShirtQuery, ProductSearchtShirtQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ProductSearchtShirtQuery, ProductSearchtShirtQueryVariables>(ProductSearchtShirtDocument, options);
        }
